...
def build_parser() -> argparse.ArgumentParser:
    ...
    # Auto-enable opt-in extensions (writes run_folder/aidlc-docs/aidlc-state.yaml)
    enable_group = parser.add_mutually_exclusive_group()
    enable_group.add_argument(
        "--auto-enable-extensions",
        dest="auto_enable_extensions",
        action="store_true",
        help="Automatically enable opt-in extensions by writing run-level state",
    )
    enable_group.add_argument(
        "--no-auto-enable-extensions",
        dest="auto_enable_extensions",
        action="store_false",
        help="Do not auto-enable opt-in extensions (default)",
    )
