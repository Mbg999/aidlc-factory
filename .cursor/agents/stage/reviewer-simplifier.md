...
description: Simplification reviewer. Applies code-simplification skill. Flags premature abstraction, dead code, over-engineering, redundant layers. Runs in parallel with other reviewers. Do not invoke directly — use the orchestrator.
model: inherit
readonly: true
is_background: true
---
