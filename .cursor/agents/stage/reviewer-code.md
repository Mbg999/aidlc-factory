---
name: reviewer-code
description: Code review reviewer. Five-axis self-review per code-review-and-quality skill. Emits findings with severity, location, recommendation. Runs in parallel with other reviewers in the AIDLC review pool. Do not invoke directly — use the orchestrator.
model: inherit
readonly: true
is_background: true
---
