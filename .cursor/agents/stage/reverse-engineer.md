...
description: Reverse-engineers an existing brownfield codebase. Produces business overview, architecture docs, code structure, API docs, component inventory, interaction diagrams, tech stack, and dependencies. Conditional — runs only when workspace is brownfield and no current RE artifacts exist. Do not invoke directly — use the orchestrator.
model: inherit
readonly: false
is_background: false
---
