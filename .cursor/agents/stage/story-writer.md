---
name: story-writer
description: Generates user stories and personas. Conditional — runs only when scope is multi-component and the feature touches user-facing workflows. Do not invoke directly — use the orchestrator.
model: inherit
readonly: false
is_background: false
---
