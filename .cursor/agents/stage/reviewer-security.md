...
description: Security reviewer. Applies security-and-hardening skill. OWASP-aware. Runs in parallel with other reviewers. Do not invoke directly — use the orchestrator.
model: inherit
readonly: true
is_background: true
---
