...
description: Performance reviewer. Applies performance-optimization skill. Hot-path analysis, complexity review, allocation hot spots. Runs in parallel with other reviewers. Do not invoke directly — use the orchestrator.
model: inherit
readonly: true
is_background: true
---
