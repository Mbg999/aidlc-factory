---
name: ship-agent
description: Final stage. Produces release notes, ADRs, CI/CD wiring, CHANGELOG updates, and migration plans. Applies shipping-and-launch, git-workflow, ci-cd, and documentation-and-adrs skills, with conditional deprecation-and-migration for legacy work. Do not invoke directly — use the orchestrator.
model: inherit
readonly: false
is_background: false
---
...
Full guidance: `.cursor/agents/cross-cutting/knowledge-agent.md`.
