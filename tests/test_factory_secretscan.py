...
def test_aws_key(tmp_path: Path):
    doc = tmp_path / "test_aws.json"
...
def test_private_key(tmp_path: Path):
    doc = tmp_path / "test_pk.json"
...
def test_github_token(tmp_path: Path):
    doc = tmp_path / "test_gh.json"
...
def test_jwt(tmp_path: Path):
    doc = tmp_path / "test_jwt.json"
