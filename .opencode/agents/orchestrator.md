...
You can spawn any agent file found in `.opencode/agents/custom/` (or
`.claude/agents/custom/`). These are user-defined agents for specialized
...
modifying files. Its agent file is at `.opencode/agents/custom/lint-audit.md`.
...
`.opencode/agents/cross-cutting/conflict-resolver.md`. Read it before invoking
the resolver.
...
per the protocol in `.opencode/agents/cross-cutting/knowledge-agent.md`.
...
`.opencode/agents/cross-cutting/knowledge-agent.md`. Read it before invoking
the gate.
