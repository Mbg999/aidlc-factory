...
description: Analyzes user requirements, generates clarifying questions, and produces the requirements.md spec. Inception phase, runs after Workspace Scout. Two-pass execution due to the human-approval gate on questions.
