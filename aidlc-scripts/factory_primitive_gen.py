...
DS_PRIMITIVES = Path(__file__).resolve().parent.parent / "design-system" / "primitives"
...
def main() -> int:
    ...
    parser.add_argument("--ds-path", type=str, default=str(DS_PRIMITIVES),
                        help=f"Path to primitives directory (default: {DS_PRIMITIVES})")
