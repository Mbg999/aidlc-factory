...
description: Security reviewer. Applies security-and-hardening skill. OWASP-aware. High-capability model recommended because security misses become incidents.
---

# Reviewer — Security

> **Model capability:** high-capability — security misses become incidents. Use your most capable model, especially for fintech, healthcare, or auth systems.
...
Full guidance: `.other/agents/cross-cutting/knowledge-agent.md`. Security
