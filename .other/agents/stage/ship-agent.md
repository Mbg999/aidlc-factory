...
> **Model capability:** capable — documentation, release notes, and changelog generation. Needs good writing and summarization skills.
...
Full guidance: `.other/agents/cross-cutting/knowledge-agent.md`.
