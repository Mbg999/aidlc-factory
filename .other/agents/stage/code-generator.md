...
> **Model capability:** high-capability — code generation quality determines build success. Use your most capable model.
...
`.other/agents/cross-cutting/knowledge-agent.md`. When in doubt: do NOT
