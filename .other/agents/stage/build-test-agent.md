...
> **Model capability:** capable — build debugging and test analysis. Needs good error interpretation skills.
...
Full guidance: `.other/agents/cross-cutting/knowledge-agent.md`. Don't emit
