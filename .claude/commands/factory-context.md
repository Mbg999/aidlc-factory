...
Adopt the role and authority rules from @.claude/agents/orchestrator.md.
...
1. Parse the run-id from `$ARGUMENTS`. If a second argument is present, treat it as `--depth`.
